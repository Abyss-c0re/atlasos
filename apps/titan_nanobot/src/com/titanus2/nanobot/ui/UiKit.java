...
/**
 * OS Material / DeviceDefault helpers for Nanobot UI.
 * <p>
...
public final class UiKit {
    /** @deprecated Theme background — do not paint custom black. */
    public static final int BG = 0x00000000;
    public static final int PANEL = 0x00000000;
    public static final int TILE = 0x00000000;
    public static final int TILE_ON = 0x00000000;
    public static final int BORDER = 0x00000000;
    public static final int BORDER_ON = 0x00000000;
    ...
    public static final int ACCENT = 0xFF018786;
    public static final int LIVE = 0xFF018786;
    public static final int WARN = 0xFFB00020;
    public static final int OK = 0xFF2E7D32;

    public static final int PAD_H = 16;
    public static final int PAD_V = 12;
    public static final int GAP = 8;
    public static final int TILE_MIN_H_DP = 48;
    /**
    ...
    public static int liveBody(Context c) {
        return resolveAttr(c, android.R.attr.colorBackground, nightFallback(c, 0xFFFAFAFA, 0xFF121212));
    }

    public static int textColor(Context c) {
        return resolveAttr(c, android.R.attr.textColorPrimary, nightFallback(c, TEXT, 0xFFE0E0E0));
    }

    public static int mutedColor(Context c) {
        return resolveAttr(c, android.R.attr.textColorSecondary, nightFallback(c, MUTED, 0xFFB0B0B0));
    }

    private static int nightFallback(Context c, int day, int night) {
        if (c == null) return day;
        int ui = c.getResources().getConfiguration().uiMode
            & android.content.res.Configuration.UI_MODE_NIGHT_MASK;
        return ui == android.content.res.Configuration.UI_MODE_NIGHT_YES ? night : day;
    }
    ...
    private static android.graphics.drawable.Drawable selectableItemBgDrawable(Context c) {
        int ripple = resolveAttr(c, android.R.attr.colorControlHighlight, 0x33212121);
    ...
    public static void screen(LinearLayout root) {
        ...
        // Transparent — inherit Activity theme background
    ...
    public static void section(LinearLayout root, String t) {
        ...
        tv.setPadding(0, dp(tv, 18), 0, dp(tv, 8));
        root.addView(tv);
    }
    ...
    private static void applySelectedChrome(TextView tile) {
        ...
        if (on) {
            tile.setTextColor(liveAccent(c));
        } else {
