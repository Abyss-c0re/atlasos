package com.example.uitemplates;
...
public final class UiKit {
    ...
    /** Kept for compile compatibility; Material uses system shapes. */
    public static final float CORNER_DP = -1f;
    ...
    public static android.graphics.drawable.GradientDrawable square(int fill, int border) {
        ...
        // System default corner (do not force 0)
        return d;
    }
    ...
    public static TextView stateLine(LinearLayout root) {
        ...
        int sel = selectableItemBg(root.getContext());
        if (sel != 0) tv.setBackgroundResource(sel);
    ...
    public static LinearLayout navRow(LinearLayout parent, String title, String summary,
        ...
        int sel = selectableItemBg(ctx);
        if (sel != 0) row.setBackgroundResource(sel);
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
            ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        lp.bottomMargin = 2;
        row.setLayoutParams(lp);
    ...
    public static TextView listRow(LinearLayout parent, String primary, String secondary,
        ...
        b.setMinHeight(dp(b, TILE_MIN_H_DP));
        int sel = selectableItemBg(ctx);
        if (sel != 0) b.setBackgroundResource(sel);
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
            ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        lp.bottomMargin = 2;
        b.setLayoutParams(lp);
